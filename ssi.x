...
/********************************************************************20**
     ...
     Sid:      ssi.x@@/main/67 - Fri May 14 20:13:18 2010
...
#ifdef SS_HISTOGRAM_SUPPORT 
EXTERN  FIXME_DECLARE(S16) SPutMsgNew ARGS((Buffer *mBuf, U32 line,  U8 *fileName));
EXTERN  FIXME_DECLARE(S16) SGetMsgNew ARGS((Region region, Pool pool, Buffer * *mBufPtr, U32 line,  U8 *fileName));
EXTERN  FIXME_DECLARE(S16) SGetSBufNew ARGS((Region region,Pool pool, Data * *bufPtr, Size size, U32 line, U8 *fileName));
EXTERN  FIXME_DECLARE(S16) SPutSBufNew ARGS((Region region, Pool pool, Data *buf, Size size, U32 line, U8 *fileName));
#else
EXTERN  FIXME_DECLARE(S16) SPutMsg ARGS((Buffer *mBuf));
EXTERN  FIXME_DECLARE(S16) SGetMsg ARGS((Region region, Pool pool, Buffer * *mBufPtr));
EXTERN  FIXME_DECLARE(S16) SGetSBuf ARGS((Region region,Pool pool, Data * *bufPtr, Size size));
EXTERN  FIXME_DECLARE(S16) SPutSBuf ARGS((Region region, Pool pool, Data *buf, Size size));
#endif /* SS_HISTOGRAM_SUPPORT */
...
EXTERN  FIXME_DECLARE(S16) SGetDateTime ARGS((DateTime *dt));
 /* ssi_x_001.main_57 : Additions */
...
#ifndef SS_MULTIPLE_PROCS
EXTERN  FIXME_DECLARE(S16) SGetEntInst ARGS((Ent *ent, Inst *inst));
EXTERN  FIXME_DECLARE(S16) SSetEntInst ARGS((Ent ent, Inst inst));
EXTERN  FIXME_DECLARE(ProcId) SFndProcId ARGS((void));
EXTERN  FIXME_DECLARE(Void) SSetProcId ARGS((ProcId pId));
#endif /* SS_MULTIPLE_PROCS */
...
/********************************************************************30**
         ...
         End of file:     ssi.x@@/main/67 - Fri May 14 20:13:18 2010
